...
public class FogThingy extends BlockWithEntity {
    ...
    public FogThingy(Settings settings, boolean emitsParticles) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.FOG_THINGY_BLOCK_ENTITY, (world1, pos, state1, be) -> FogThingyBlockEntity.clientTick(world1, pos, state1, this));
    }
}
